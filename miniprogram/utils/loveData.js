...
const LOVE_FIELDS = [
  { id: 'classic', name: '经典古风', icon: 'flower', desc: '古诗词中的浪漫表达' },
  { id: 'modern', name: '甜蜜现代', icon: 'heart', desc: '现代情话甜言蜜语' },
  { id: 'celebrity', name: '名人情话', icon: 'star', desc: '名人经典爱情语录' },
  { id: 'poetry', name: '诗词传情', icon: 'book', desc: '古诗词中的爱情名句' }
]
