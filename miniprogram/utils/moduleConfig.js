  ...
  modules: [
    ...
    },
    {
      ...
      colors: {
        ...
        shadow: 'rgba(0, 200, 83, 0.15)'
      },
      tags: { category: { field: 'category', icon: 'categoryIcon' }, ai: 'AI专家' },
      aiTags: ['增长', '营销'],
      refreshText: '换一条',
      loadingText: '增长策略生成中...',
      placeholderText: '点击「换一条」获取增长知识',
      posterType: 'growth',
      slogan: '增长是企业的生命线'
    },
    {
    ...
    },
    {
      ...
      colors: {
        ...
        shadow: 'rgba(94, 53, 177, 0.15)'
      },
      tags: { category: { field: 'category', icon: 'categoryIcon' }, ai: 'AI学者' },
      aiTags: ['心理学', '精神分析'],
      refreshText: '换一条',
      loadingText: '精神分析中...',
      placeholderText: '点击「换一条」了解心理学知识',
      posterType: 'freud',
      slogan: '探索潜意识，解读心灵'
    },
    {
      ...
      colors: {
        ...
        bg: 'rgba(136, 14, 79, 0.1)',
        shadow: 'rgba(136, 14, 79, 0.15)'
      },
      tags: { category: { field: 'category', icon: 'categoryIcon' }, ai: 'AI专家' },
      aiTags: ['品牌', '时尚'],
      refreshText: '换一条',
      loadingText: '品牌故事加载中...',
      placeholderText: '点击「换一条」了解奢侈品牌',
